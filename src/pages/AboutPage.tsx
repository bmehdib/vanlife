  ...
  return (
    <section className="w-screen h-full">
      <div className="w-full">
        <img
          className="w-full h-[25rem] object-cover object-bottom"
          src={bg}
          alt=""
        />
      </div>
      <div className="text-white grid gap-4 mt-4 ">
      ...
      <div className="text-black  w-3/4 bg-orange-50 mx-auto p-8 rounded-xl">
